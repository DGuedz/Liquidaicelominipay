...
const celoRpcUrl =
  chain === "sepolia" && rawRpcUrl.toLowerCase() === "https://alfajores-forno.celo-testnet.org"
    ? defaultRpcUrl
...
const defaultFeeCurrencyAddress = chain === "sepolia" ? SEPOLIA_USDM : MAINNET_USDM;
...
export const env = {
  ...
  celoChain: chain,
  celoChainId: chain === "sepolia" ? 11142220 : 42220,
  celoRpcUrl,
  feeCurrencyAddress,
  usdStableAddress: feeCurrencyAddress,
  sortedOraclesAddress: readString(
    "SORTED_ORACLES_ADDRESS",
    chain === "sepolia" ? SEPOLIA_SORTED_ORACLES : MAINNET_SORTED_ORACLES,
  ),
  oracleReferenceStableAddress: readString(
    "ORACLE_REFERENCE_STABLE_ADDRESS",
    chain === "sepolia" ? SEPOLIA_ORACLE_REFERENCE_STABLE : MAINNET_ORACLE_REFERENCE_STABLE,
  ),
