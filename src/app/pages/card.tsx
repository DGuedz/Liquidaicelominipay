...
const BAAS_PARTNERS = [
  ...
  },
  {
    ...
    q: "Q2",
    desc: "MiniPay + Daimo allows receiving funds from Base, Solana, Ethereum or any L2 directly into Celo Vault. The bridge UX stays abstracted for the user.",
    LogoIcon: BridgeIcon,
  },
  {
    name: "Pismo (Visa)",
  ...
  },
  {
    ...
    bg: "rgba(163,217,119,0.1)",
    q: "Q2",
    desc: "Mento V3 is the FX layer for stable routes (USDm↔BRLm↔EURm), optimized for low slippage and predictable execution.",
    LogoIcon: SwapIcon,
  },
];
...
const RISK_METRICS = [
  ...
  },
  {
    ...
    bg: "rgba(6,182,212,0.1)",
    icon: Clock,
    desc: "Execution time depends on network and liquidity · buffer covers short gaps",
  },
];
...
const CELO_NEWS = [
  {
    ...
    desc: "stCELO can be used as collateral in Morpho for managed looping. Allocation and leverage are adjusted automatically by the risk engine.",
  ...
  },
  {
    ...
    headline: "Native BRLm route · low slippage",
    desc: "Mento V3 powers USDm↔BRLm↔EURm conversions for PIX and treasury flows with liquidity-aware routing.",
    impact: "Lower conversion friction when the BRLm route is available.",
    color: "#F59E0B",
  },
  {
    id: "hackathon",
